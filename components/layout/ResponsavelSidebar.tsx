...
// Menu para responsável: funcionalidades permitidas
...
export const ResponsavelSidebar: React.FC<ResponsavelSidebarProps> = ({ onNavigate }) => {
  ...
  return (
    <View style={styles.sidebar}>
      <View style={styles.sidebarHeader}>
        <Text style={styles.sidebarTitle}>Responsável</Text>
