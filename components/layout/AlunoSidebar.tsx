...
// Menu para aluno: acesso limitado, só vê seus próprios dados
const menuItems: MenuItem[] = [
  { label: 'Dashboard', route: '/', icon: 'house.fill' },
  { label: 'Meus Dados', route: '/alunos', icon: 'person.fill' },
];
...
export const AlunoSidebar: React.FC<AlunoSidebarProps> = ({ onNavigate }) => {
  ...
  return (
    <View style={styles.sidebar}>
      <View style={styles.sidebarHeader}>
        <Text style={styles.sidebarTitle}>Aluno</Text>
